...
import net.liopyu.geckojs.cache.AnimatableIdCache;
import net.liopyu.geckojs.util.RenderUtils;

/**
 * The {@link net.liopyu.geckojs.core.animatable.GeoAnimatable GeoAnimatable} interface specific to {@link net.minecraft.world.item.Item Items}.
