package net.liopyu.geckojs.animatable;
...
import net.liopyu.geckojs.network.packet.EntityAnimDataSyncPacket;
import net.liopyu.geckojs.network.packet.EntityAnimTriggerPacket;
 ...
 * <b>NOTE:</b> This <u>cannot</u> be used for entities using the {@link net.liopyu.geckojs.renderer.GeoReplacedEntityRenderer}
...
public interface GeoEntity extends GeoAnimatable {
	 ...
	 * @param animName The name of animation to trigger. This needs to have been registered with the controller via {@link net.liopyu.geckojs.core.animation.AnimationController#triggerableAnim AnimationController.triggerableAnim}
	 */
