package net.liopyu.geckojs.constant;
 ...
 * Additionally, it encourages use of cached {@link net.liopyu.geckojs.core.animation.RawAnimation RawAnimations}, to reduce overheads.
 */
public final class DefaultAnimations {
	 ...
	 * Recommended:
	 * <ul>
	 *     <li>{@link net.liopyu.geckojs.animatable.GeoEntity GeoEntity}: state -> animatable</li>
	 *     <li>{@link net.liopyu.geckojs.animatable.GeoBlockEntity GeoBlockEntity}: state -> animatable</li>
	 *     <li>{@link net.liopyu.geckojs.animatable.GeoReplacedEntity GeoReplacedEntity}: state -> state.getData(DataTickets.ENTITY)</li>
	 *     <li>{@link net.liopyu.geckojs.animatable.GeoItem GeoItem}: state -> state.getData(DataTickets.ITEMSTACK)</li>
