package net.liopyu.geckojs.core.molang;
...
import net.liopyu.geckojs.core.molang.expressions.MolangCompoundValue;
import net.liopyu.geckojs.core.molang.expressions.MolangValue;
import net.liopyu.geckojs.core.molang.expressions.MolangVariableHolder;
import net.liopyu.geckojs.core.molang.functions.CosDegrees;
import net.liopyu.geckojs.core.molang.functions.SinDegrees;
