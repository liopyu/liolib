 ...
 * @see net.liopyu.geckojs.util.GeckoLibUtil
...
public class GeckoLib {
	 ...
	 * Note that doing so will prevent {@link net.liopyu.geckojs.renderer.GeoItemRenderer Items} from animating properly
	 */
