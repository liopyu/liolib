package net.liopyu.geckojs.resource;
...
/**
 * Metadata class that stores the data for GeckoLib's {@link net.liopyu.geckojs.renderer.layer.AutoGlowingGeoLayer emissive texture feature} for a given texture
 */
