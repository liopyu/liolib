package net.liopyu.geckojs.network;
...
import net.liopyu.geckojs.network.packet.*;
...
public final class GeckoLibNetwork {
	 ...
	 * It is recommended that you don't call this directly, instead implementing and calling {@link net.liopyu.geckojs.animatable.SingletonGeoAnimatable#registerSyncedAnimatable}
	 */
