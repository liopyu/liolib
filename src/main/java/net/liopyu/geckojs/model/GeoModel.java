package net.liopyu.geckojs.model;
...
import net.liopyu.geckojs.GeckoLibException;
import net.liopyu.geckojs.cache.GeckoLibCache;
...
import net.liopyu.geckojs.core.animation.AnimationProcessor;
import net.liopyu.geckojs.core.molang.MolangParser;
import net.liopyu.geckojs.core.molang.MolangQueries;
import net.liopyu.geckojs.core.object.DataTicket;
import net.liopyu.geckojs.loading.object.BakedAnimations;
import net.liopyu.geckojs.renderer.GeoRenderer;
import net.liopyu.geckojs.util.RenderUtils;
...
public abstract class GeoModel<T extends GeoAnimatable> implements CoreGeoModel<T> {
	 ...
	 * @return An {@link Optional} containing the {@link net.liopyu.geckojs.cache.object.GeoBone} if one matches, otherwise an empty Optional
	 */
	public Optional<net.liopyu.geckojs.cache.object.GeoBone> getBone(String name) {
