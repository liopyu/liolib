...
import net.liopyu.geckojs.loading.json.raw.*;
import net.liopyu.geckojs.loading.json.typeadapter.BakedAnimationsAdapter;
import net.liopyu.geckojs.loading.json.typeadapter.KeyFramesAdapter;
