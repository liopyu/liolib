package net.liopyu.geckojs.loading.json.typeadapter;
...
import net.liopyu.geckojs.core.keyframe.BoneAnimation;
import net.liopyu.geckojs.core.keyframe.Keyframe;
import net.liopyu.geckojs.core.keyframe.KeyframeStack;
import net.liopyu.geckojs.core.molang.MolangException;
import net.liopyu.geckojs.core.molang.MolangParser;
import net.liopyu.geckojs.core.molang.expressions.MolangValue;
import net.liopyu.geckojs.loading.object.BakedAnimations;
import net.liopyu.geckojs.util.JsonUtil;
...
/**
 * {@link com.google.gson.Gson} {@link JsonDeserializer} for {@link net.liopyu.geckojs.loading.object.BakedAnimations}.<br>
