...
public interface GeoRenderer<T extends GeoAnimatable> {
	 ...
	 *     <li>For {@link net.liopyu.geckojs.animatable.GeoBlockEntity Tile Entities} and {@link net.liopyu.geckojs.animatable.GeoItem Items}, it's currently unused</li>
	 * </ul>
