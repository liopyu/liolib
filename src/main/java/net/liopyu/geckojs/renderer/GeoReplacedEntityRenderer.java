package net.liopyu.geckojs.renderer;
...
import net.liopyu.geckojs.event.GeoRenderEvent;
...
/**
 * An alternate to {@link GeoEntityRenderer}, used specifically for replacing existing non-geckojs
 * entities with geckojs rendering dynamically, without the need for an additional entity class
 */
