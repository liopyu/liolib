package net.liopyu.geckojs.renderer.layer;
 ...
 * Supports both {@link net.liopyu.geckojs.animatable.GeoItem GeckoLib} and {@link net.minecraft.world.item.ArmorItem Vanilla} armor models.<br>
