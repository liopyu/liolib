...
/**
 * An alternate to {@link GeoEntityRenderer}, used specifically for replacing existing non-liolib
 * entities with liolib rendering dynamically, without the need for an additional entity class
 */
