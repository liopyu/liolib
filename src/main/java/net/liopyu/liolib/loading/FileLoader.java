package net.liopyu.liolib.loading;
...
public final class FileLoader {
	/**
	 * Load up and deserialize an animation json file to its respective {@link net.liopyu.liolib.core.animation.Animation} components
