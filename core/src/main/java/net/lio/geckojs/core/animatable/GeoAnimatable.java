 ...
 */
package net.lio.geckojs.core.animatable;

import net.lio.geckojs.core.animatable.model.CoreGeoBone;
import net.lio.geckojs.core.animation.AnimatableManager;
import net.lio.geckojs.core.animation.AnimationController;
import net.lio.geckojs.core.animatable.instance.AnimatableInstanceCache;
...
public interface GeoAnimatable {
	 ...
	 * Override this method in your animatable object and add your controllers via {@link net.lio.geckojs.core.animation.AnimatableManager.ControllerRegistrar#add ControllerRegistrar.add}.
	...
	/**
	 * Defines the speed in which the {@link net.lio.geckojs.core.animation.AnimationProcessor} should return
