...
package net.lio.geckojs.core.animation;
...
import net.lio.geckojs.core.animatable.model.CoreGeoBone;
import net.lio.geckojs.core.animatable.model.CoreGeoModel;
import net.lio.geckojs.core.keyframe.*;
import net.lio.geckojs.core.keyframe.event.CustomInstructionKeyframeEvent;
import net.lio.geckojs.core.keyframe.event.ParticleKeyframeEvent;
import net.lio.geckojs.core.keyframe.event.SoundKeyframeEvent;
import net.lio.geckojs.core.keyframe.event.data.CustomInstructionKeyframeData;
import net.lio.geckojs.core.keyframe.event.data.KeyFrameData;
import net.lio.geckojs.core.keyframe.event.data.ParticleKeyframeData;
import net.lio.geckojs.core.keyframe.event.data.SoundKeyframeData;
import net.lio.geckojs.core.molang.MolangParser;
import net.lio.geckojs.core.molang.MolangQueries;
import net.lio.geckojs.core.object.Axis;
import net.lio.geckojs.core.object.PlayState;
import net.lio.geckojs.core.state.BoneSnapshot;
...
public class AnimationController<T extends GeoAnimatable> {
	...
	/**
	 * Cache the relevant {@link BoneSnapshot BoneSnapshots} for the current {@link net.lio.geckojs.core.animation.AnimationProcessor.QueuedAnimation}
