...
import net.lio.geckojs.core.animatable.model.CoreBakedGeoModel;
import net.lio.geckojs.core.animatable.model.CoreGeoBone;
import net.lio.geckojs.core.animatable.model.CoreGeoModel;
import net.lio.geckojs.core.keyframe.AnimationPoint;
import net.lio.geckojs.core.keyframe.BoneAnimationQueue;
...
public class AnimationProcessor<T extends GeoAnimatable> {
	...
	/**
	 * {@link Animation} and {@link net.lio.geckojs.core.animation.Animation.LoopType} override pair,
