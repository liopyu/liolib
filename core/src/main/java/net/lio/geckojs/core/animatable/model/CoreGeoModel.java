package net.lio.geckojs.core.animatable.model;

import net.lio.geckojs.core.animatable.GeoAnimatable;
import net.lio.geckojs.core.animation.Animation;
import net.lio.geckojs.core.animation.AnimationProcessor;
import net.lio.geckojs.core.animation.AnimationState;
...
public interface CoreGeoModel<E extends GeoAnimatable> {
	 ...
	 * @param animatable The {@code GeoAnimatable} instance currently being rendered
	 * @param animTime The internal tick counter kept by the {@link net.lio.geckojs.core.animation.AnimatableManager manager} for this animatable
	 */
