...
import net.lio.geckojs.core.object.DataTicket;
...
public class AnimatableManager<T extends GeoAnimatable> {
	 ...
	 * @param animName The name of animation to trigger. This needs to have been registered with the controller via {@link net.lio.geckojs.core.animation.AnimationController#triggerableAnim AnimationController.triggerableAnim}
	 */
